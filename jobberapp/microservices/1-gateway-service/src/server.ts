...
import { CustomError, IErrorResponse, winstonLogger } from '@vengateshganesangv/jobber-shared';
...
export class GatewayServer {
  ...
  private securityMiddleware(app: Application): void {
    app.set('trust proxy', 1); // Tells the app to trust the header added by proxy X-Forwarded-For: clientip, X-Forwarded-Proto: https or https, X-Forwarded-Host: original header
    app.use(
      cookieSession({
        name: 'session',
